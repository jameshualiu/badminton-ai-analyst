    ...
    return (
        <div className="min-h-screen bg-background text-foreground overflow-hidden">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    className="absolute top-0 right-0 w-[800px] h-[800px] rounded-full bg-glow/25 blur-[120px] transform-gpu will-change-transform"
                    animate={{
                        scale: [1, 1.2, 1],
                ...
                />
                <motion.div
                    className="absolute bottom-0 left-0 w-[600px] h-[600px] rounded-full bg-glow-2/20 blur-[110px] transform-gpu will-change-transform"
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
                <div className="text-center">
                    ...
                    >
                        Transform your badminton performance with AI-powered
                        video analysis, intelligent insights, and precision shot
                        tracking.
                    </motion.p>
                    ...
                    >
                        ...
                        <button className="px-8 py-4 bg-card/40 border border-border/50 hover:bg-card/60 hover:border-primary/40 rounded-2xl transition-all flex items-center gap-2">
                    ...
                    {[
                        {
                            ...
                            description:
                                "Advanced video playback with AI-powered frame analysis to identify every critical moment.",
                        ...
                        },
                        {
                            ...
                            description:
                                "Instant breakdown of shot counts by type, match duration, and total rally data extracted directly from your footage.",
                            gradient: "from-primary/10 to-accent/10",
                            iconBg: "from-primary to-accent",
                        },
                        {
                            ...
                            title: "Shot Heatmaps",
                            description:
                                "Visualize your performance with precision court mapping and detailed shot analytics.",
                            gradient: "from-primary/10 to-accent/10",
                            iconBg: "from-primary to-accent",
                        },
                    ].map((feature, index) => (
                        <motion.div
                            key={index}
                            className={`group relative bg-gradient-to-br ${feature.gradient} border border-border/50 rounded-3xl p-8 hover:border-primary/50 transition-all`}
                            initial={{ opacity: 0, y: 30 }}
                        ...
                        >
                            <div
                                className={`inline-flex p-4 bg-gradient-to-br ${feature.iconBg} rounded-2xl shadow-lg shadow-primary/30 mb-6`}
                            >
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                >
                    <div className="bg-gradient-to-br from-card/70 to-background/40 border border-border/50 rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 border-t border-border/40 py-8 mt-20">
                <div className="max-w-7xl mx-auto px-6 text-center text-muted-foreground text-sm">
                    © 2026 Badminton AI Analyst. Powered by YOLOv8 and
                    TrackNetV2.
                </div>
            </div>
        </div>
